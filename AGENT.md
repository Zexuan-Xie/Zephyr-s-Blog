...
- Worktree root: /home/zephry_xzx/xlab/blog/.omx/team/resume-xlab-blog-from-1df8000b/worktrees/worker-3
- Team state root: /home/zephry_xzx/xlab/blog/.omx/state
- Inbox path: /home/zephry_xzx/xlab/blog/.omx/state/team/resume-xlab-blog-from-1df8000b/workers/worker-3/inbox.md
- Mailbox path: /home/zephry_xzx/xlab/blog/.omx/state/team/resume-xlab-blog-from-1df8000b/mailbox/worker-3.json
...
- Worker status path: /home/zephry_xzx/xlab/blog/.omx/state/team/resume-xlab-blog-from-1df8000b/workers/worker-3/status.json
- Worker identity path: /home/zephry_xzx/xlab/blog/.omx/state/team/resume-xlab-blog-from-1df8000b/workers/worker-3/identity.json

## Protocol
1. Read your inbox at `/home/zephry_xzx/xlab/blog/.omx/state/team/resume-xlab-blog-from-1df8000b/workers/worker-3/inbox.md`.
...
3. Send startup ACK before task work:
   ...
   `omx team api send-message --input "{"team_name":"resume-xlab-blog-from-1df8000b","from_worker":"worker-3","to_worker":"leader-fixed","body":"ACK: worker-3 initialized"}" --json`
...
7. Use mailbox delivery flow:
   - `omx team api mailbox-list --input "{"team_name":"resume-xlab-blog-from-1df8000b","worker":"worker-3"}" --json`
   - `omx team api mailbox-mark-delivered --input "{"team_name":"resume-xlab-blog-from-1df8000b","worker":"worker-3","message_id":"<MESSAGE_ID>"}" --json`
