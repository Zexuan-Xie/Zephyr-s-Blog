...
## Worker Identity
- Team: resume-xlab-blog-exac-1ad13b6b
- Worker: worker-3
- Role: executor
- Leader cwd: /home/zephry_xzx/xlab/blog
- Worktree root: /home/zephry_xzx/xlab/blog/.omx/team/resume-xlab-blog-exac-1ad13b6b/worktrees/worker-3
- Team state root: /home/zephry_xzx/xlab/blog/.omx/state
- Inbox path: /home/zephry_xzx/xlab/blog/.omx/state/team/resume-xlab-blog-exac-1ad13b6b/workers/worker-3/inbox.md
- Mailbox path: /home/zephry_xzx/xlab/blog/.omx/state/team/resume-xlab-blog-exac-1ad13b6b/mailbox/worker-3.json
- Leader mailbox path: /home/zephry_xzx/xlab/blog/.omx/state/team/resume-xlab-blog-exac-1ad13b6b/mailbox/leader-fixed.json
- Task directory: /home/zephry_xzx/xlab/blog/.omx/state/team/resume-xlab-blog-exac-1ad13b6b/tasks
- Worker status path: /home/zephry_xzx/xlab/blog/.omx/state/team/resume-xlab-blog-exac-1ad13b6b/workers/worker-3/status.json
- Worker identity path: /home/zephry_xzx/xlab/blog/.omx/state/team/resume-xlab-blog-exac-1ad13b6b/workers/worker-3/identity.json

## Protocol
1. Read your inbox at `/home/zephry_xzx/xlab/blog/.omx/state/team/resume-xlab-blog-exac-1ad13b6b/workers/worker-3/inbox.md`.
...
3. Send startup ACK before task work:
   ...
   `omx team api send-message --input "{"team_name":"resume-xlab-blog-exac-1ad13b6b","from_worker":"worker-3","to_worker":"leader-fixed","body":"ACK: worker-3 initialized"}" --json`
...
5. Read task files from `/home/zephry_xzx/xlab/blog/.omx/state/team/resume-xlab-blog-exac-1ad13b6b/tasks/task-<id>.json` using bare `task_id` values in APIs.
...
7. Use mailbox delivery flow:
   - `omx team api mailbox-list --input "{"team_name":"resume-xlab-blog-exac-1ad13b6b","worker":"worker-3"}" --json`
   - `omx team api mailbox-mark-delivered --input "{"team_name":"resume-xlab-blog-exac-1ad13b6b","worker":"worker-3","message_id":"<MESSAGE_ID>"}" --json`
