...
- Worktree root: /home/zephry_xzx/xlab/blog/.omx/team/resume-xlab-blog-from-38975700/worktrees/worker-1
- Team state root: /home/zephry_xzx/xlab/blog/.omx/state
- Inbox path: /home/zephry_xzx/xlab/blog/.omx/state/team/resume-xlab-blog-from-38975700/workers/worker-1/inbox.md
- Mailbox path: /home/zephry_xzx/xlab/blog/.omx/state/team/resume-xlab-blog-from-38975700/mailbox/worker-1.json
...
- Worker status path: /home/zephry_xzx/xlab/blog/.omx/state/team/resume-xlab-blog-from-38975700/workers/worker-1/status.json
- Worker identity path: /home/zephry_xzx/xlab/blog/.omx/state/team/resume-xlab-blog-from-38975700/workers/worker-1/identity.json

## Protocol
1. Read your inbox at `/home/zephry_xzx/xlab/blog/.omx/state/team/resume-xlab-blog-from-38975700/workers/worker-1/inbox.md`.
...
3. Send startup ACK before task work:
   ...
   `omx team api send-message --input "{"team_name":"resume-xlab-blog-from-38975700","from_worker":"worker-1","to_worker":"leader-fixed","body":"ACK: worker-1 initialized"}" --json`
...
7. Use mailbox delivery flow:
   - `omx team api mailbox-list --input "{"team_name":"resume-xlab-blog-from-38975700","worker":"worker-1"}" --json`
   - `omx team api mailbox-mark-delivered --input "{"team_name":"resume-xlab-blog-from-38975700","worker":"worker-1","message_id":"<MESSAGE_ID>"}" --json`
